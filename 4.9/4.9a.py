...
if __name__ == "__main__":
    ...
    for mc in range(N_MC): # MC loop
        ...
        print "K",mc        
    Es2_ratio=numpy.divide(Es2_list_max_Z,Es2_list_max_K)
    ...
    plt.grid()
    #pylab.legend(loc=4)
    plt.xlabel(r"$\frac{E^{Z^{2}}_{max}}{E^{K^{2}}_{max}}$")
