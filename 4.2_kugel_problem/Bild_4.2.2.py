...
if __name__ == "__main__":
    ...
    freqs=numpy.array([30,50,100,150,200,300,350,400,450,500,800,1000])*1e6#freqs=numpy.array([30,50,100, 200, 400, 600, 700, 800, 900, 1100, 1200, 1300, 1400])*1000000#numpy.array(range(30,301,30))*1000000#numpy.logspace(10,11,3)  # generate frequencies
    kas=a_EUT*2*pi*freqs/c # vector with k*a values (a: EUT radius)
    deval=numpy.linspace(180,420,100)
    Ns=Ns_hansen_1D
    n_listen=0                
