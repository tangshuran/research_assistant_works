...
if __name__ == "__main__":
    ...
    #pylab.plot( numpy.linspace(1,3,500), [FD_hertz_one_cut(d) for d in  numpy.linspace(1,3,500)], label="Theoretical CDF (a=0 m)")
    #pylab.plot( numpy.linspace(1,3,500), [FD_hertz_one_cut_costheta(d) for d in numpy.linspace(1,3,500) ], label="Theoretical CDF cos(theta)(a=0 m)")
